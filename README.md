...
本教程共包含 **12 个章节**，覆盖前置数学基础到 OI/ACM 竞赛高级专题：
...
### [1.1 初等数学（必备）](./00_数学基础.md#11-初等数学必备)
...
### [1.2 离散数学（核心基础）](./00_数学基础.md#12-离散数学核心基础)
...
### [1.3 线性代数（重要）](./00_数学基础.md#13-线性代数重要)
...
### [1.4 概率论与数理统计（LeetCode 高频）](./00_数学基础.md#14-概率论与数理统计leetcode-高频)
...
### [1.5 数论基础（OI 竞赛核心）](./00_数学基础.md#15-数论基础oi-竞赛核心)
...
### [1.6 数学分析（了解即可）](./00_数学基础.md#16-数学分析了解即可)
...
### [1.7 博弈论（竞赛重要）](./00_数学基础.md#17-博弈论竞赛重要)
...
### [1.8 形式语言与自动机（了解）](./00_数学基础.md#18-形式语言与自动机了解)
...
### [2.1 编程语言选择](./00_编程基础.md#21-编程语言选择)
...
### [2.2 必备语言特性](./00_编程基础.md#22-必备语言特性)
...
### [2.3 输入输出与调试](./00_编程基础.md#23-输入输出与调试)
...
### [2.4 时间复杂度分析](./00_编程基础.md#24-时间复杂度分析)
...
### [3.2 基础算法](./01_算法基础与复杂度分析.md#32-基础算法)
...
### [3.3 基础算法示例](./01_算法基础与复杂度分析.md#33-基础算法示例)
...
### [4.1 排序算法总览](./03_排序与搜索.md#41-排序算法总览)
...
### [4.3 LeetCode 高频排序 & 搜索题型](./03_排序与搜索.md#43-leetcode-高频排序--搜索题型)
...
### [5.2 线段树 & 树状数组详解](./04_进阶数据结构.md#52-线段树--树状数组详解)
...
### [5.3 并查集详解](./04_进阶数据结构.md#53-并查集详解)
...
### [5.5 LeetCode 高频进阶数据结构题型](./04_进阶数据结构.md#55-leetcode-高频进阶数据结构题型)
...
### [6.1 图的基本概念](./05_图论算法.md#61-图的基本概念)
...
### [6.2 图的存储结构](./05_图论算法.md#62-图的存储结构)
...
### [6.7 其他图论算法](./05_图论算法.md#67-其他图论算法)
...
### [6.7.1 图论经典模型与定理](./05_图论算法.md#671-图论经典模型与定理)
...
### [6.8 LeetCode 高频图论题型](./05_图论算法.md#68-leetcode-高频图论题型)
...
### [7.1 动态规划基础](./06_动态规划.md#71-动态规划基础)
...
### [7.2 动态规划分类](./06_动态规划.md#72-动态规划分类)
...
### [7.3 背包问题详解](./06_动态规划.md#73-背包问题详解)
...
### [7.4 经典 DP 问题](./06_动态规划.md#74-经典-dp-问题)
...
### [7.5 LeetCode 高频 DP 题型](./06_动态规划.md#75-leetcode-高频-dp-题型)
...
### [8.1 字符串匹配](./07_字符串算法.md#81-字符串匹配)
...
### [8.2 字符串哈希](./07_字符串算法.md#82-字符串哈希)

- 滚动哈希 (Rabin-Karp)
- 双哈希 (Double Hash)
- 哈希冲突处理

### [8.3 字符串其他算法](./07_字符串算法.md#83-字符串其他算法)
...
### [8.4 LeetCode 高频字符串题型](./07_字符串算法.md#84-leetcode-高频字符串题型)
...
### [9.3 OI 竞赛计算几何题型](./09_计算几何.md#93-oi-竞赛计算几何题型)
...
### [10.1 数论算法](./08_数论与组合数学.md#101-数论算法)
...
### [10.2 组合数学](./08_数论与组合数学.md#102-组合数学)
...
### [10.3 经典数论模板](./08_数论与组合数学.md#103-经典数论模板)
...
### [10.4 OI 竞赛数论专题](./08_数论与组合数学.md#104-oi-竞赛数论专题)
...
### [11.1 复杂度理论](./10_高级专题.md#111-复杂度理论)

| 复杂度类 | 说明 | 经典问题 |
|----------|------|----------|
| **P** | 多项式时间可解 | 最短路径、最小生成树 |
| **NP** | 多项式时间可验证 | 哈密顿回路、TSP |
| **NP-Complete** | NP 中最难的问题 | SAT、3-SAT、顶点覆盖 |
| **NP-Hard** | 至少和 NP 一样难 | 停机问题、TSP 优化版 |
| **EXP** | 指数时间可解 | 某些博弈问题 |
| **PSPACE** | 多项式空间可解 | 量化布尔公式 |
| **ZPP** | 期望多项式时间 | 随机化算法 |
| **RP / co-RP** | 单侧错误随机化 | 素数判定 |
| **BPP** | 双侧错误随机化 | 大多数随机化算法 |

### [11.2 近似算法](./10_高级专题.md#112-近似算法)

| 算法 | 近似比 | 问题 |
|------|--------|------|
| **贪心顶点覆盖** | 2 | 顶点覆盖 |
| **Christofides 算法** | 1.5 | 度量 TSP |
| **贪心集合覆盖** | ln n | 集合覆盖 |
| **PTAS** | 1+ε | 子集和、背包 |

### [11.3 随机化算法](./10_高级专题.md#113-随机化算法)

| 算法 | 类型 | 说明 |
|------|------|------|
| **Miller-Rabin** | 蒙特卡洛 | 素数判定 |
| **Pollard-Rho** | 拉斯维加斯 | 大数分解 |
| **随机快速排序** | 随机化 | 避免最坏情况 |
| **跳跃表 (Skip List)** | 概率数据结构 | 替代平衡树 |
| **蓄水池抽样** | 流算法 | 均匀随机采样 |
| **拉斯维加斯算法** | 总是正确 | 随机化快排 |
| **蒙特卡洛算法** | 可能有错误 | 数值积分 |

### [11.4 在线算法与流算法](./10_高级专题.md#114-在线算法与流算法)

| 算法 | 问题 | 说明 |
|------|------|------|
| **LRU 缓存** | 页面置换 | 最近最少使用 |
| **LFU 缓存** | 页面置换 | 最不经常使用 |
| **HyperLogLog** | 基数估计 | 大数据去重计数 |
| **Count-Min Sketch** | 频率估计 | 近似计数 |
| **Bloom Filter** | 存在性判断 | 空间效率高 |

### [11.5 并行与分布式算法](./10_高级专题.md#115-并行与分布式算法)
...
### [11.6 启发式算法与元启发式](./10_高级专题.md#116-启发式算法与元启发式)

| 算法 | 类型 | 说明 | 应用场景 |
|------|------|------|----------|
| **模拟退火 (SA)** | 物理启发 | 温度参数控制接受坏解概率 | TSP、组合优化 |
| **遗传算法 (GA)** | 进化启发 | 选择、交叉、变异 | 多目标优化 |
| **蚁群算法 (ACO)** | 群体智能 | 信息素引导搜索 | 路径规划、调度 |
| **粒子群优化 (PSO)** | 群体智能 | 速度-位置更新 | 连续优化 |
| **禁忌搜索 (TS)** | 局部搜索 | 记忆机制避免重复 | 组合优化 |
| **爬山算法** | 贪心搜索 | 局部最优 | 简单优化 |
| **分支定界 (Branch & Bound)** | 精确算法 | 剪枝搜索空间 | 整数规划、TSP |

### [11.7 算法设计范式总结](./10_高级专题.md#117-算法设计范式总结)

| 范式 | 思想 | 代表算法 |
|------|------|----------|
| **分治 (Divide & Conquer)** | 分解→解决→合并 | 归并排序、FFT、最近点对 |
| **贪心 (Greedy)** | 局部最优 → 全局最优 | Huffman、Dijkstra、Kruskal |
| **动态规划 (DP)** | 子问题 + 状态转移 | 背包、LCS、最短路 |
| **回溯 (Backtracking)** | 深度搜索 + 剪枝 | N 皇后、数独 |
| **分支定界 (B&B)** | 回溯 + 上下界剪枝 | TSP、整数规划 |
| **减治 (Decrease & Conquer)** | 减小问题规模 | 二分查找、拓扑排序 |
| **变换 (Transform & Conquer)** | 问题变形 | 堆化、平衡树 |
| **时空权衡 (Space-Time Tradeoff)** | 用空间换时间 | 哈希表、DP 表 |
| **随机化 (Randomized)** | 引入随机性 | 随机快排、Miller-Rabin |
| **近似 (Approximation)** | 放弃精确解 | PTAS、贪心近似 |
| **在线 (Online)** | 无预知输入 | LRU、竞争比分析 |
| **迭代加深 (Iterative Deepening)** | 逐步加深搜索 | IDDFS、IDA\* |

---

## 12. 第十层：OI/ACM 竞赛高级专题

### [12.1 OI 竞赛级别高级数据结构](./10_高级专题.md#121-oi-竞赛级别高级数据结构)

| 数据结构 | 核心特性 | 复杂度 |
|----------|----------|--------|
| **Link-Cut Tree (LCT)** | 动态树、路径操作 | 摊还 $O(\log n)$ |
| **树链剖分 (HLD)** | 树路径 → 线段树 | $\log^2 n$ |
| **KD-Tree** | 多维空间查询 | $n^{1-1/k}$ |
| **可持久化线段树（主席树）** | 历史版本查询 | $O(\log n)$ |
| **可持久化 Trie** | 历史版本异或查询 | $O(\log M)$ |
| **可持久化平衡树** | 历史版本序列操作 | $O(\log n)$ |
| **块状链表** | 分块思想 | $O(\sqrt{n})$ |
| **莫队算法 (Mo's Algorithm)** | 离线区间查询 | $O((n+q)\sqrt{n})$ |
| **CDQ 分治** | 离线多维偏序 | $O(n \log^2 n)$ |
| **整体二分** | 批量二分答案 | $O((n+q) \log n)$ |
| **分块 (Sqrt Decomposition)** | 大块维护、小块暴力 | $O(\sqrt{n})$ |
| **珂朵莉树 (ODT)** | 区间赋值操作 | $O(n \log n)$ |
| **舞蹈链 (Dancing Links X)** | 精确覆盖问题 | 指数级 |
| **李超线段树 (Li Chao Tree)** | 线段/函数最值维护 | $\log^2 V$ |
| **吉司机线段树 (Segment Tree Beats)** | 维护历史最值、区间最值剪枝 | $\log^2 n$ |
| **ZKW 线段树** | 非递归线段树 | $O(\log n)$ |
| **猫树** | 静态区间信息 $O(1)$ 查询 | $O(n \log n)$ 预处理 |
| **划分树/归并树** | 静态区间第 K 大 | $O(\log n)$ |
| **平衡树 (SBT/FHQ Treap/AVL/WBLT)** | 多种实现 | $O(\log n)$ |
| **B 树 / B+ 树 / 2-3-4 树** | 多叉平衡树 | $O(\log n)$ |
| **van Emde Boas 树** | 整数全集 $\log \log U$ | $\log \log U$ |
| **斐波那契堆** | 摊还优化 Dijkstra | $O(1)$ 插入 |
| **二叉索引树变体** | 二维 BIT、区间更新 BIT | $O(\log n)$ |
| **动态开点线段树** | 值域大时按需开点 | $\log V$ |
| **线段树合并/分裂** | 动态维护集合 | $O(n \log n)$ |
| **树套树** | 线段树套平衡树/树状数组 | $\log^2 n$ |
| **LCT 维护子树信息** | 动态森林 | $O(\log n)$ |
| **Top Tree** | 更通用的动态树 | $O(\log n)$ |
| **哈希链表** | 拉链法/开放地址法 | $O(1)$ 均摊 |
| **dancing links** | 双向十字链表 | 精确覆盖 |
| **陈教授树** | 字符串合并 | $O(n \log n)$ |

### [12.2 经典竞赛题型](./10_高级专题.md#122-经典竞赛题型)

| 题型 | 说明 | 算法 |
|------|------|------|
| **最大团 / 最大独立集** | 图论 NP-hard | 分支定界、Bron–Kerbosch |
| **最小路径覆盖** | DAG 覆盖 | 二分图匹配 |
| **最大权闭合子图** | 网络流 | 最小割 |
| **差分约束** | 不等式系统 | 最长/最短路 |
| **最大密度子图** | 图论优化 | 参数搜索+最小割 |
| **最大权匹配** | 一般图 | 带花树 (Blossom) |
| **最小树形图** | 有向图 MST | 朱刘算法 |
| **稳定婚姻问题** | 匹配 | Gale-Shapley |
| **最大 XOR 子集** | 线性基 | 线性基模板 |
| **区间众数** | 离线查询 | 回滚莫队 |

### [12.3 竞赛数学专题](./10_高级专题.md#123-竞赛数学专题)

| 专题 | 说明 | 复杂度 |
|------|------|--------|
| **杜教筛** | 积性函数前缀和 | $n^{2/3}$ |
| **Min_25 筛** | 素数计数/积性函数 | $n^{3/4} / \log n$ |
| **类欧几里得算法** | 直线下方整点计数 | $O(\log n)$ |
| **常系数线性递推 (BM)** | 求递推式 | $k^2 \log n$ |
| **多项式的多项式** | 求逆、ln、exp、sqrt、幂 | $O(n \log n)$ |
| **FWT (快速沃尔什变换)** | 卷积 | $O(n \log n)$ |
| **子集卷积** | 子集 DP 优化 | $O(n^2 2^n)$ |
| **拉格朗日插值** | 多项式插值 | $O(n^2)$ / $O(n)$ |
| **生成函数** | 组合计数 | 视问题而定 |

### [12.4 推荐学习路径（OI 竞赛版）](./10_高级专题.md#124-推荐学习路径oi-竞赛版)
...
### [12.5 推荐学习路径（LeetCode 面试版）](./10_高级专题.md#125-推荐学习路径leetcode-面试版)
...
### [13.1 数据结构谱系](./README.md#131-数据结构谱系)
...
### [13.3 知识体系关系图](./README.md#133-知识体系关系图)
...
### [13.4 遗漏检查](./README.md#134-遗漏检查)

经过系统审查，以下内容为补充的重要知识点：

#### 数据结构补充

| 数据结构 | 说明 | 复杂度 | 应用场景 |
|----------|------|--------|----------|
| **跳表 (Skip List)** | 多层链表，概率平衡 | $O(\log n)$ 均摊 | Redis 有序集合、替代平衡树 |
| **十字链表** | 有向图存储 | $V+E$ | 有向图遍历 |
| **邻接多重表** | 无向图存储 | $V+E$ | 无向图遍历 |
| **广义表** | 递归数据结构 | 视结构而定 | Lisp 语言、表达式树 |

#### 算法补充

| 算法 | 说明 | 复杂度 | 应用场景 |
|------|------|--------|----------|
| **IDA\* (迭代加深 A\*)** | 迭代加深 + A* 启发 | $b^d$ | 大状态空间搜索 |
| **模拟退火 (SA)** | 随机化启发式 | 视迭代次数 | 优化问题、TSP 近似 |
| **遗传算法 (GA)** | 进化启发式 | 视种群规模 | 多目标优化 |
| **蚁群算法 (ACO)** | 群体智能 | 视迭代次数 | 路径规划、组合优化 |
| **粒子群优化 (PSO)** | 群体智能 | 视迭代次数 | 连续优化 |
| **单纯形法** | 线性规划 | $2^n$ 最坏，实际多项式 | 线性规划问题 |
| **位运算技巧** | lowbit、枚举子集 | $O(1)$ / $2^k$ | 状态压缩、集合操作 |
| **对拍 (Stress Testing)** | 暴力对拍正确解 | 视数据规模 | 竞赛调试、验证算法 |

#### 数学补充

| 知识点 | 说明 | 关联内容 |
|--------|------|----------|
| **博弈论基础** | SG 函数、Nim 博弈、巴什博弈、威佐夫博弈 | 博弈 DP、竞赛 |
| **信息论基础** | 熵、信息熵、Huffman 编码、Shannon 编码 | 数据压缩、编码 |
| **形式语言** | 正则语言、上下文无关语言、乔姆斯基层级 | 自动机、编译器 |
| **自动机理论** | DFA、NFA、图灵机、可计算性 | 计算理论 |
| **可计算性** | 停机问题、不可判定问题 | 计算复杂性 |
| **计算几何进阶** | 闵可夫斯基和、凸多边形交、半平面交 | 高级几何问题 |

#### 字符串补充

| 数据结构/算法 | 说明 | 复杂度 |
|--------------|------|--------|
| **后缀树 (Suffix Tree)** | 后缀的树形结构 | $O(n)$ 构建，$O(m)$ 查询 |
| **回文自动机 (PAM)** | 回文串的自动机 | $O(n)$ 构建 |
| **后缀平衡树** | 动态维护后缀 | $\log n$ 操作 |
| **Manacher 进阶** | 多串回文、回文树 | $O(n)$ |

#### 图论补充

| 算法 | 说明 | 复杂度 |
|------|------|--------|
| **Johnson 全源最短路** | 处理负权边的全源最短路 | $VE \log V$ |
| **最大流最小割定理** | 网络流基本定理 | - |
| **有上下界的网络流** | 带约束的网络流 | 视算法而定 |
| **全局最小割** | Stoer-Wagner 算法 | $VE + V^2 \log V$ |
| **平面图最小割** | 平面图特殊算法 | $O(n \log n)$ |

#### 动态规划补充

| 类型 | 说明 | 经典问题 |
|------|------|----------|
| **区间 DP 优化** | 四边形不等式、Knuth 优化 | 石子合并 |
| **DP 状态设计** | 状态压缩技巧、状态拆分 | 复杂状态设计 |
| **DP 转移优化** | 决策单调性、斜率优化、凸包优化 | 高级 DP 优化 |
| **概率 DP 进阶** | 期望 DP、概率生成函数 | 随机过程 |
| **博弈 DP 进阶** | SG 函数、Nim 博弈、威佐夫博弈 | 博弈论 |
| **树形 DP 进阶** | 树上背包、树形依赖 DP | 树上优化 |
...
| **闵可夫斯基和** | 两个凸包的和 | $n + m$ |
| **凸多边形交** | 两个凸多边形的交集 | $n + m$ |
| **半平面交进阶** | 多个半平面的交集 | $O(n \log n)$ |
| **自适应辛普森积分** | 数值积分 | $O(n)$ |
| **三维计算几何** | 三维凸包、三维最近点对 | $O(n \log n)$ |
| **圆的相关算法** | 圆与圆交、圆与多边形交 | 视问题而定 |

#### LeetCode 面试补充

| 题型 | 说明 | 技巧 |
|------|------|------|
| **设计类** | LRU、LFU、线程池、数据库连接池 | 数据结构组合 |
| **位运算题** | 只出现一次的数字、位运算枚举 | lowbit、异或技巧 |
| **数学题** | 数论、组合数学、概率 | 数学推导 |
| **交互题** | 猜测、查询、反馈 | 二分、交互设计 |
| **多指针** | 三指针、四指针 | 扩展双指针 |
| **前缀和进阶** | 二维前缀和、差分进阶 | 区域和查询 |
| **单调栈进阶** | 矩形面积、柱状图问题 | 单调性维护 |
| **并查集进阶** | 带权并查集、可撤销并查集 | 扩展并查集 |

### [13.5 参考资源](./README.md#135-参考资源)
...
> **说明**：本文档结合了中文维基百科（[Wikipedia 中文 ZIM 文件](file:///home/louis/Downloads/wikipedia_zh_all_maxi_2026-05.zim)）中相关词条的内容整理而成。借助 `zimsearch` 工具检索了包括数据结构、算法、图论、数论、动态规划、计算几何、组合数学、概率论、线性代数等核心领域的词条，确保知识体系的完整性和权威性。