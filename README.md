...
**详细内容请参阅**：[《11_高级算法与复杂度理论.md》](./11_高级算法与复杂度理论.md) ⬅ 点击前往（含子章节导航）

| 子章节 | 内容概要 | 详细文档 |
|--------|----------|----------|
| 11.1 复杂度理论 | P vs NP、NP-Complete、近似算法 | [11_高级算法与复杂度理论.md](./11_高级算法与复杂度理论.md#1-复杂度理论) |
| 11.2 随机化算法 | Miller-Rabin、Pollard-Rho、跳跃表、蓄水池抽样 | [11_高级算法与复杂度理论.md](./11_高级算法与复杂度理论.md#2-随机化算法) |
| 11.3 在线算法与流算法 | LRU/LFU 缓存、HyperLogLog、Count-Min Sketch | [11_高级算法与复杂度理论.md](./11_高级算法与复杂度理论.md#3-在线算法与流算法) |
| 11.4 并行与分布式算法 | 并行排序、MapReduce、Paxos/Raft | [11_高级算法与复杂度理论.md](./11_高级算法与复杂度理论.md#4-并行与分布式算法) |
| 11.5 启发式算法 | 模拟退火、遗传算法、蚁群算法、禁忌搜索 | [11_高级算法与复杂度理论.md](./11_高级算法与复杂度理论.md#5-启发式算法与元启发式) |
| 11.6 算法设计范式总结 | 12 种设计范式总览 | [11_高级算法与复杂度理论.md](./11_高级算法与复杂度理论.md#6-算法设计范式总结) |
...
**详细内容请参阅**：[《12_OI竞赛高级专题.md》](./12_OI竞赛高级专题.md) ⬅ 点击前往（含子章节导航）

| 子章节 | 内容概要 | 详细文档 |
|--------|----------|----------|
| 12.1 高级数据结构 | LCT、树链剖分、主席树、莫队、CDQ 分治、舞蹈链等 30+ 种 | [12_OI竞赛高级专题.md](./12_OI竞赛高级专题.md#1-oi-竞赛级别高级数据结构) |
| 12.2 经典竞赛题型 | 最大团、最小路径覆盖、差分约束、稳定婚姻、线性基等 | [12_OI竞赛高级专题.md](./12_OI竞赛高级专题.md#2-经典竞赛题型) |
| 12.3 竞赛数学专题 | 杜教筛、Min_25 筛、类欧几里得、BM 算法、多项式、FWT | [12_OI竞赛高级专题.md](./12_OI竞赛高级专题.md#3-竞赛数学专题) |
| 12.4 学习路径（OI 竞赛版） | 入门→提高→省选→国家队 4 阶段路线 | [12_OI竞赛高级专题.md](./12_OI竞赛高级专题.md#4-推荐学习路径oi-竞赛版) |
| 12.5 学习路径（LeetCode 面试版） | 基础→进阶→强化→冲刺 4 阶段路线 | [12_OI竞赛高级专题.md](./12_OI竞赛高级专题.md#5-推荐学习路径leetcode-面试版) |
