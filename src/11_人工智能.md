...
- [14.2 AI 核心算法体系](#142-ai-核心算法体系)
  ...
  - [14.2.5 多模态 AI](./11d_生成式AI与大模型.md#五多模态-ai) — 包含在 [11d_生成式AI与大模型.md](./11d_生成式AI与大模型.md) 中
...
涵盖：监督学习（线性回归、SVM、决策树、随机森林、XGBoost 等）、无监督学习（K-Means、DBSCAN、PCA 等）、集成学习、半监督学习、模型评估与模型选择（混淆矩阵、PR/ROC-AUC、回归指标、交叉验证与超参调优）、异常检测（Isolation Forest、LOF、One-Class SVM）、可解释机器学习（SHAP、LIME）、推荐系统（协同过滤、矩阵分解、深度推荐）
...
涵盖：MLP、CNN、RNN/LSTM、Transformer、GNN、GAN、扩散模型，以及训练工程（优化器 SGD/Momentum/Adam/AdamW 与学习率调度、归一化层 BN/LN/IN/GN、正则化 Dropout/Weight Decay 等）、词嵌入（Word2Vec、GloVe）、高效注意力与长上下文（FlashAttention、MQA/GQA）、语音识别与时间序列建模、元学习与持续学习、分布式训练与联邦学习等
...
涵盖：MDP、Q-Learning、SARSA、DQN、Policy Gradient、PPO、SAC、MCTS、MuZero，以及进阶前沿（Rainbow、TD3、模仿学习与逆强化学习 GAIL、离线强化学习 CQL、多智能体 MADDPG）等
...
涵盖：GAN、扩散模型、大语言模型（LLM）、预训练、SFT、RLHF、DPO、RAG、MoE、模型量化、文本生成解码策略、知识蒸馏、AI Agent 等
