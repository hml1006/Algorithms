...
本教程共包含 **14 个编号章节**（01–14，含核心算法章节、附录与 AI 专题），另以前置的**数学基础**与**编程基础**开篇，覆盖 **12 个层级**（前置 → 第零层 → 第十层）：
...
| 03 | [排序与搜索](./03_排序与搜索.md) | 第二层 | 16 种排序算法、二分/三分搜索、DFS/BFS、回溯法 |
...
| 13 | [附录：知识体系图谱](./13_附录.md) | 附录 | 数据结构谱系、算法分类、复杂度对照表 |
| 14 | [人工智能](./11_人工智能.md) | AI 专题 | AI 发展历史、ML/DL 算法、强化学习、大模型 |
...
> 以下为完整的算法知识体系，从前置数学基础到 OI/ACM 竞赛高级专题，覆盖 12 个层级（前置 → 第零层 → 第十层），并附算法附录（第 13 章）与人工智能专题（第 14 章）。
...
> 数据结构、算法、复杂度等知识的系统化图谱，作为快速回顾与总查阅参考。

**详细内容请参阅**：[《13_附录.md》](./13_附录.md) ⬅ 点击前往（含数据结构谱系、算法分类、复杂度对照表）

| 子章节 | 内容概要 | 详细文档 |
|--------|----------|----------|
| 13.1 数据结构谱系 | 线性 / 树形 / 图结构 / 哈希 分类总览 | [13_附录.md](./13_附录.md) |
| 13.2 算法谱系 | 图论 / DP / 数论 / 计算几何 等算法归类 | [13_附录.md](./13_附录.md) |
| 13.3 知识体系关系图 | 各知识点间关联与演进 | [13_附录.md](./13_附录.md) |
| 13.4 参考资源 | 竞赛 / 面试常用资料 | [13_附录.md](./13_附录.md) |
