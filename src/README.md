...
### [11.1 复杂度理论：P vs NP](./11_高级算法与复杂度理论.md#1-复杂度理论)
...
### [11.2 近似算法](./11_高级算法与复杂度理论.md#2-近似算法)
...
### [11.3 随机化算法](./11_高级算法与复杂度理论.md#3-随机化算法)
...
### [11.4 在线算法与流算法](./11_高级算法与复杂度理论.md#4-在线算法与流算法)
...
### [11.5 并行与分布式算法](./11_高级算法与复杂度理论.md#5-并行与分布式算法)
...
### [11.6 启发式算法与元启发式](./11_高级算法与复杂度理论.md#6-启发式算法与元启发式)
...
### [11.7 算法设计范式总结](./11_高级算法与复杂度理论.md#7-算法设计范式总结)
...
### [12.1 高级数据结构](./12_OI竞赛高级专题.md#1-oi-竞赛级别高级数据结构)
...
### [12.2 经典竞赛题型](./12_OI竞赛高级专题.md#2-经典竞赛题型)
...
### [12.3 竞赛数学专题](./12_OI竞赛高级专题.md#3-竞赛数学专题)
...
### [12.4 学习路径（OI 竞赛版）](./12_OI竞赛高级专题.md#41-oi-竞赛版)

入门 → 提高 → 省选 → 国家队，4 阶段进阶路线。

### [12.5 学习路径（LeetCode 面试版）](./12_OI竞赛高级专题.md#42-leetcode-面试版)
...
*本书由 [mdbook](https://github.com/rust-lang/mdBook) 构建，使用 [mdbook-katex](https://github.com/lzanini/mdbook-katex) 插件渲染 LaTeX 公式。*